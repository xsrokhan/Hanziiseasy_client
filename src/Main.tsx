...
const Main = (props: {chars: Array<CharacterAndWord>}) => {
  ...
  // Hanzi pinyin and translation states (visible/not visible)
  const [pinyinVisible, setPinyinVisible] = useState(true)
  const [hanziTranslationVisible, setHanziTranslationVisible] = useState(true)
        ...
        <>
          ...
          <div className="charContainer">
            ...
            <div className="char">
              ...
              <div className="pinyin" onClick={() => setPinyinVisible(prev => !prev)}>
                {pinyinVisible ? pinyinConverter(currentROF[charNumber - 1]["pinyin"]) : "Show"}
              </div>
              <div className="pinyin_translation">
                <div onClick={() => setHanziTranslationVisible(prev => !prev)}>
                  {hanziTranslationVisible ? currentROF[charNumber - 1]["english"][0] : "Show"}
                </div>
